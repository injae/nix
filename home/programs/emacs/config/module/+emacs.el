;;; +emacs.el --- Summery -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:
...
(use-package dired-wit-mac :ensure nil :no-require t
    :if *is-mac*
    :config
...
(use-package wsl-setting :ensure nil :no-require t
:if *is-wsl*
:preface
...
(use-package not-wsl-setting :ensure nil :no-require t
:unless *is-wsl*
:config (set-frame-parameter nil 'alpha 0.95)
)
;; emacs large file setting
(use-package so-long-mode :ensure nil :no-require t

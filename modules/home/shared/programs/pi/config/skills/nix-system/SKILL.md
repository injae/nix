...
**Exceptions**: project-local files and explicitly requested temporary runtime-only files are edited directly in their derived paths.
...
| File | When to Read |
|------|-------------|
| `pi-config.md` | Pi config work (skills, extensions, AGENTS.md, settings.json, `~/.pi/agent/`) |
